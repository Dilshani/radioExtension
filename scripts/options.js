require.config({
    ...
    "use strict";
    function c(a) {
        var b = document.createElement("a"), c = new Blob([a], {
            encoding: "UTF-8",
    ...
    function o() {
        var b = a("#stations").empty(), c = r.getStations();
    ...
    function p() {
        a("ul.menu").on("click", 'li[data-page="add"]', h).on("click", 'li[data-page="stations"]', i).on("click", 'li[data-page="flash"]', j).on("click", 'li[data-page="hotkeys"]', l).on("click", 'li[data-page="export"]', m).on("click", 'li[data-page="import"]', n).on("click", 'li[data-page="changelog"]', k), a("#stations").on("click", ".station > .icon-edit", function (c) {
            c.preventDefault();
            ...
            b.preventDefault();
            var c = a("#import"), d = c.find(".error"), e = c.find(".success"), f = c.find("textarea"), g = r.importData(f.val());
