require.config({
    ...
    function d(b) {
        var c = a('.station[data-name="' + b + '"]').addClass("favorite"), d = c.prev(), e = parseInt(c.outerHeight(), 10), f = parseInt(c.position().top, 10) + parseInt(o.scrollTop(), 10);
    ...
    function e(b) {
        var c = a('.station[data-name="' + b + '"]').removeClass("favorite"), d = c.is(":last-child") ? p.next(".station") : c.next(".station"), e = parseInt(c.outerHeight(), 10), f = parseInt(c.position().top, 10) + parseInt(o.scrollTop(), 10), g = parseInt(p.height(), 10) - e;
    ...
    function f(c, d, e) {
        var f = n.isFavorite(c), g = a("<div/>", {
            "class": "station",
            "data-name": c
        }).toggleClass("favorite", f), h = a("<div/>", {"class": "image"}), i = a("<i/>", {
            "class": "icon icon-play",
            title: b.translate("play")
        }), j = a("<i/>", {"class": "icon icon-stop", title: b.translate("stop")}), k = a("<h3/>", {
            "class": "title",
            text: d
        }), l = a("<i/>", {
            "class": "icon icon-like",
            title: b.translate("like")
    ...
    function g() {
        var a = q.find(".equalizer"), b = 3, c = 1, d = 1, e = parseInt(a.css("width"), 10), f = parseInt(a.css("height"), 10), g = Math.round(e / (c + b)), h = document.createElement("canvas");
    ...
    function j() {
        o.on("click", ".station", function (b) {
            ...
            a.preventDefault(), chrome.tabs.create({url: "mailto:erandacr@gmail.com?Subject=Eranda%20Radio%20Extension"})
    ...
    function k(c) {
        ...
        var d = function () {
            ...
            if (c) {
                var d = a('.station[data-name="' + c.name + '"]').addClass("active"), e = q.find(".description").empty();
    ...
    var m = chrome.extension.getBackgroundPage(), n = m.getStorage(), o = a("#stations"), p = a("#favorites"), q = a("#player");
